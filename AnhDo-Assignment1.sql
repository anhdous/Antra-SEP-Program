...
-- 11. Write a query so you retrieve rows that have a Name 
-- that begins with the letters SPO, but is then not followed by the letter K. After this zero or more letters can exists. 
...
SELECT DISTINCT ISNULL(ProductSubcategoryID,' ') ProductSubcategoryID , ISNULL(Color,'') Color
FROM Production.Product
